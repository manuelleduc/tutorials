...
- Shonan Challenge for Generative Programming ([PDF](http://www.cs.tsukuba.ac.jp/~kam/paper/pepm2013.pdf)) ([official code repository](https://github.com/StagedHPC/shonan-challenge))
